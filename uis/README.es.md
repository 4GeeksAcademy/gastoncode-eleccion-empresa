...
Cada subcarpeta dentro de `uis/` debe corresponder a **una interfaz de usuario concreta** (por ejemplo `website`, `suppliers-backoffice`) e incluir su propia documentación técnica y funcional.
