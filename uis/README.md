...
Each subfolder inside `uis/` must correspond to **one specific user interface** (for example: `website`, `suppliers-backoffice`) and include its own technical and functional documentation.
